...
Class Form1
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim buttonCell As DataGridViewDisableButtonCell = CType(dataGridView1.Rows(3).Cells("Buttons"), DataGridViewDisableButtonCell)
        Dim buttonCell2 As DataGridViewDisableButtonCell = CType(dataGridView1.Rows(4).Cells("Buttons"), DataGridViewDisableButtonCell)
        buttonCell.Enabled = bool
        buttonCell.Value = bool.ToString

        buttonCell2.Enabled = bool
        buttonCell2.Value = bool.ToString
        bool = Not bool
