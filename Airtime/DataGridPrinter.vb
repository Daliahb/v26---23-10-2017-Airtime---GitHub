...
#Region "Data Source"
    ...
    Public ReadOnly Property TotalRows As Integer
        Get
            Return _dataGridView.Rows.Count 'MappedColumnToBaseColumnSourceDataTable.DefaultView.Count
        End Get
    End Property
            ...
            For nColumn = 0 To ColumnCount - 1
                ...
                ElseIf _dataGridView IsNot Nothing Then
                    ...
                    If (rcLastCell.Width = 0) Then
                        ...
                        rcLastCell.Height = 22 '_dataGridView.Rows(nColumn).Height
                    End If
                End If
            ...
            For nColumn = 0 To ColumnCount - 1
                ...
                ElseIf (_dataGridView IsNot Nothing) Then
                    ...
                    If (rcCell.Width = 0) Then
                        ...
                        rcCell.Height = 22 '_dataGridView.Rows(nColumn).Height
                    End If
                End If
                If rcCell.Width > 0 Then
...
#Region "Private methods"
    ...
    Private Sub PrintGridLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal RowNumber As Integer)
        ...
        Try
            ...
            End If
            Dim nColumn As Integer
            For nColumn = 0 To Items.Cells.Count - 1
                If _ColumnBounds(nColumn).Page = _CurrentPageAcross Then
                    ...
                    If rcCell.Width > 0 Then
                        ...
                        Try
                            Columntext = Convert.ToString(Items.Cells(nColumn).Value) '(MappedColumnToBaseColumn(nColumn)))
                        Catch
                        End Try
    ...
    Private Function GetRowItems(ByVal rowNumber As Integer) As DataGridViewRow

        Return _dataGridView.Rows(rowNumber)
    ...
    Private Function GridColumnCount() As Integer
        ...
        Return Me._dataGridView.ColumnCount
